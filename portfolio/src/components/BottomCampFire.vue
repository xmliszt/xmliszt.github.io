<template>
  <div class="container" aria-label="campfire animation">
    <div class="campfire-wrapper">
      ...
      <div class="campfire-footer">
        <p>
          Campfire animation based on the work of Dave Chenell & Jackie Zen
          (jackiezen)
        </p>
      </div>
    </div>
...
.flame-1 {
  ...
  opacity: 0.4;
  z-index: 999;
  filter: drop-shadow(0 -10px 15px rgb(255, 206, 57));
}
...
.flame-2 {
  ...
  opacity: 0.8;
  z-index: 999;
  filter: drop-shadow(0 5px 15px rgb(255, 166, 13));
}
...
.flame-4 {
  ...
  height: 50px;
  border: none;
  background-color: rgba(255, 248, 195, 0.4);
  border-radius: 50%;
  filter: blur(16px);
}
